...
module CircleciOpenapi
  ...
  class InlineResponse2002Metrics
    ...
    def self.openapi_types
      {
        ...
        :'failed_runs' => :'Integer',
        :'success_rate' => :'Float',
        :'duration_metrics' => :'InlineResponse2002MetricsDurationMetrics',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircleciOpenapi::InlineResponse2002Metrics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircleciOpenapi::InlineResponse2002Metrics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @mttr < 0
        invalid_properties.push('invalid value for "mttr", must be greater than or equal to 0.')
      end
      ...
      if @total_recoveries < 0
        invalid_properties.push('invalid value for "total_recoveries", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @total_recoveries < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] mttr Value to be assigned
    def mttr=(mttr)
      if mttr.nil?
        fail ArgumentError, 'mttr cannot be nil'
      end

      if mttr < 0
        fail ArgumentError, 'invalid value for "mttr", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] total_recoveries Value to be assigned
    def total_recoveries=(total_recoveries)
      if total_recoveries.nil?
        fail ArgumentError, 'total_recoveries cannot be nil'
      end

      if total_recoveries < 0
        fail ArgumentError, 'invalid value for "total_recoveries", must be greater than or equal to 0.'
      end
