...
# Unit tests for CircleciOpenapi::InlineResponse2004MetricsDurationMetrics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircleciOpenapi::InlineResponse2004MetricsDurationMetrics do
  let(:instance) { CircleciOpenapi::InlineResponse2004MetricsDurationMetrics.new }
  ...
  describe 'test an instance of InlineResponse2004MetricsDurationMetrics' do
    it 'should create an instance of InlineResponse2004MetricsDurationMetrics' do
      expect(instance).to be_instance_of(CircleciOpenapi::InlineResponse2004MetricsDurationMetrics)
    end
  end
